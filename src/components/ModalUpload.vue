                                        ...
                                        >
                                                ...
                                                >
                                                        <div class="delete__button">
                                                                <p
                                                                        @click="handleDeleteImage(image.uuid)"
                                                                >✖︎</p>
                                                        </div>
                                                        <img
...
export default {
        ...
        setup(props) {
                ...
                const imageTypes = ["image/png", "image/jpg", "image/jpeg", "image/gif", "video/mp4", "video/webm", "video/ogg", "video/quicktime"];
